...
export function MobileNav() {
  ...
  return (
    <div className="relative z-50 pointer-events-auto md:hidden">
      <button
      ...
      <AnimatePresence>
        {open && (
          <motion.nav
            ...
            className="absolute right-0 top-14 z-50 w-56 rounded-2xl border border-line bg-surface-strong p-2 shadow-[var(--shadow-lg)] backdrop-blur-xl"
          >
            {links.map((link) => (
              <Link
                key={link.href}
