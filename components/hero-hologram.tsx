...
function HolographicHead() {
  ...
  return (
    <group
      ref={group}
      position={[isCompact ? 0.35 : 1.8, isCompact ? -0.15 : 0, 0]}
...
export function HeroHologram() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 pointer-events-none max-md:opacity-70 lg:opacity-100">
      <div
        aria-hidden
        className={`absolute right-[4%] top-[38%] h-[42%] w-[58%] -translate-y-1/2 rounded-full blur-3xl md:right-[10%] md:top-1/2 md:h-[60%] md:w-[45%] ${
          isLightTheme
      ...
      <div
        className="absolute right-0 top-[10%] hidden h-[80%] w-[50%] cursor-default pointer-events-auto sm:block"
