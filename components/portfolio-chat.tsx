    ...
    <div className="pointer-events-none fixed inset-x-4 bottom-4 z-50 sm:inset-x-auto sm:right-5 sm:bottom-5">
      <div className="ml-auto flex w-full max-w-[22rem] flex-col items-end gap-2.5">
        ...
        <button
          ...
          className="pointer-events-auto inline-flex h-12 items-center gap-2 rounded-full border border-line-strong bg-surface-strong px-3.5 text-sm font-medium text-foreground shadow-[var(--shadow-md)] backdrop-blur-xl hover:bg-surface sm:px-4"
          aria-expanded={open}
