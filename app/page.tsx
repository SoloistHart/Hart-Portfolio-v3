  ...
  return (
    <>
      ...
      <main id="main" className="relative overflow-hidden pb-20 pt-28 sm:pt-32">
        ...
        <section className="page-shell relative flex min-h-[calc(100dvh-8rem)] flex-col justify-center gap-12 pb-8 lg:gap-16 lg:pb-0">
          ...
          <div className="relative z-10 max-w-2xl lg:max-w-3xl">
            <Reveal>
              <div>
                ...
                <h1 className="mt-6 max-w-3xl text-4xl font-semibold leading-[0.95] tracking-[-0.08em] text-foreground sm:text-5xl sm:leading-[0.92] md:text-6xl lg:text-7xl">
                ...
                <div className="mt-8 flex flex-wrap gap-2.5 sm:gap-3">
                  {siteContent.hero.chips.map((chip) => (
                    <span key={chip} className="chip max-w-full">
                      {chip}
                    </span>
                  ))}
                </div>
